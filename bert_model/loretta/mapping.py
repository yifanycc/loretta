...
from .tuners import LorettaRepConfig, PrefixTuningConfig, PromptEncoderConfig, PromptTuningConfig, LorettaAdpConfig
...
PEFT_TYPE_TO_CONFIG_MAPPING = {
    ...
    "LORA": LorettaRepConfig,
    "BOTTLENECK": LorettaAdpConfig,
}
...
TRANSFORMERS_MODELS_TO_ADAPTER_TARGET_MODULES_MAPPING = {
    "bloom": ["dense_4h_to_h"],
    "gptj": ["fc_out"],
    "gpt_neo": ["c_proj"],
    "llama": ["down_proj"],
...
def _prepare_bottleneck_config(peft_config, model_config):
    if peft_config.target_modules is None:
        print(f'test {model_config["model_type"]}')
        if peft_config.use_parallel_adapter:
            ...
            print("Use the new implementation")
