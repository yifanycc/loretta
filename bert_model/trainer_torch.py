...
class OurTrainer(Trainer):
    ...
    class CustomTrainer(Trainer):
        def create_optimizer(self):
            """
            Create the optimizer. This method allows for customization of the optimizer.
            """
            return optim.SGD(self.model.parameters(), lr=self.args.learning_rate)  # Specify your own arguments
    ...
    def zo_update(self, model):
        ...
        self.lr_scheduler.step()
    def zo_update_torch(self, model):
        """
        Update the parameters with the estimated gradients.
        """
        args = self.args
