...
class PrefixTuningConfig(PromptLearningConfig):
    """
    This is the configuration class to store the configuration of a [`~peft_local_tensor.PrefixEncoder`].
...
class PrefixEncoder(torch.nn.Module):
    ...
    Example::
        ...
        >>> from peft_local_tensor import PrefixEncoder, PrefixTuningConfig >>> config = PrefixTuningConfig(
