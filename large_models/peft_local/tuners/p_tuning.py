...
class PromptEncoderConfig(PromptLearningConfig):
    """
    This is the configuration class to store the configuration of a [`~peft_new.PromptEncoder`].
...
class PromptEncoder(torch.nn.Module):
    ...
    Example::
        ...
        >>> from peft_new import PromptEncoder, PromptEncoderConfig >>> config = PromptEncoderConfig(
