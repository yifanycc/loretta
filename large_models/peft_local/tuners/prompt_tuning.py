...
class PromptTuningConfig(PromptLearningConfig):
    """
    This is the configuration class to store the configuration of a [`~peft_new.PromptEmbedding`].
...
class PromptEmbedding(torch.nn.Module):
    ...
    **Attributes**:
    ...
    Example::
        ...
        >>> from peft_new import PromptEmbedding, PromptTuningConfig >>> config = PromptTuningConfig(
