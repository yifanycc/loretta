...
class PrefixTuningConfig(PromptLearningConfig):
    """
    This is the configuration class to store the configuration of a [`~peft_new.PrefixEncoder`].
...
class PrefixEncoder(torch.nn.Module):
    ...
    Example::
        ...
        >>> from peft_new import PrefixEncoder, PrefixTuningConfig >>> config = PrefixTuningConfig(
