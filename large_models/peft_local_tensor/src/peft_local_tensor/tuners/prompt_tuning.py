...
class PromptTuningConfig(PromptLearningConfig):
    """
    This is the configuration class to store the configuration of a [`~peft_local_tensor.PromptEmbedding`].
...
class PromptEmbedding(torch.nn.Module):
    ...
    **Attributes**:
    ...
    Example::
        ...
        >>> from peft_local_tensor import PromptEmbedding, PromptTuningConfig >>> config = PromptTuningConfig(
